...
#
# Writes: dist/seijpb-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix seijpb \
  --exe-name Star_wars___Episode_I___Jedi_Power_Battles__Recompiled \
  --display-name "Star wars - Episode I - Jedi Power Battles  Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned Star wars - Episode I - Jedi Power Battles disc" \
