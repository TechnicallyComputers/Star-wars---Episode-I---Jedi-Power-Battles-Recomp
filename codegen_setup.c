...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Star wars - Episode I - Jedi Power Battles",
    .project_root_env = "STAR_WARS___EPISODE_I___JEDI_POWER_BATTLES_RECOMP_PROJECT_ROOT",
    .build_dir_env = "STAR_WARS___EPISODE_I___JEDI_POWER_BATTLES_RECOMP_BUILD_DIR",
    .force_setup_env = "STAR_WARS___EPISODE_I___JEDI_POWER_BATTLES_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.46_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Star_wars___Episode_I___Jedi_Power_Battles__Recompiled",
    .prepare_note =
